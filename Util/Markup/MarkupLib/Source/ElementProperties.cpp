...
std::vector<PropertyElement> kui::markup::Properties
{
	...
	PropertyElement{
		...
		.SetFormat = { "GetRenderState()->CornerRadius = {val}" },
		.VarType = VariableType::SizeNumber,
	},
	PropertyElement{
		.Type = PropElementType::UIBackground,
		...
		.SetFormat = { "GetRenderState()->BorderRadius = {val}" },
		.VarType = VariableType::SizeNumber,
	},
	PropertyElement{
		.Type = PropElementType::UIBackground,
		...
		.SetFormat = {"GetRenderState()->BorderColor = {val}"},
		.VarType = VariableType::Vector3,
	},
	PropertyElement{
		.Type = PropElementType::UIBackground,
	...
	PropertyElement{
		.Type = PropElementType::UIBox,
		.Name = "maxWidth",
		.Description = "The maximum width of this element.",
		.SetFormat = {"SetMaxWidth({val})"},
		.VarType = VariableType::SizeNumber,
	},
	PropertyElement{
		.Type = PropElementType::UIBox,
		.Name = "maxHeight",
		.Description = "The maximum height of this element.",
		.SetFormat = {"SetMaxHeight({val})"},
		.VarType = VariableType::SizeNumber,
	},
	PropertyElement{
		.Type = PropElementType::UIBox,
		.Name = "width",
		.Description = "The minimum and maximum width of this element.",
		.SetFormat = {"SetMinWidth({val})", "SetMaxWidth({val})"},
		.VarType = VariableType::SizeNumber,
	},
	PropertyElement{
		.Type = PropElementType::UIBox,
		.Name = "height",
		.Description = "The minimum and maximum height of this element.",
		.SetFormat = {"SetMinHeight({val})", "SetMaxHeight({val})"},
		.VarType = VariableType::SizeNumber,
	},
	PropertyElement{
		.Type = PropElementType::UIBox,
